...
try:
    scene_kwargs = {
        ...
        "render_settings":{},
        # "obj_settings":{
        #     "path": "VisFly/datasets/visfly-beta/configs/objects/pillar/pillar_objects.json",
        #     "mode": "static",
        #     "mode_kwargs": {
    ...
    # Remove 'sensor_settings' if present to avoid duplicate keyword error
    scene_kwargs.pop("sensor_settings", None)
